...
public class Ejercicio00 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < promediosMateria1.length; i++) {
            ...
            mensajeFinal = String.format("%sEstudiante: %s - promedio Materia1:%.2f. - promedio Materia2:%.2f. - promedio final: "
                    + "%.4f\n",
                    mensajeFinal,
                    estudiantes[i],promediosMateria1[i],promediosMateria1[i],
                    promediosFinales[i]);
        }
